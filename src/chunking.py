...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        if not current_text:
            return []
        # Đủ nhỏ rồi thì dừng đệ quy.
        if len(current_text) <= self.chunk_size:
            return [current_text]

        # Hết dấu phân cách (hoặc separators rỗng ngay từ đầu) -> cắt cứng theo chunk_size.
        ...
        # Gộp các mảnh lại cho gần chunk_size nhất có thể, giữ nguyên separator.
        chunks: list[str] = []
        buffer = ""
        for piece in pieces:
            ...
            # Mảnh đơn lẻ vẫn quá dài -> đệ quy với separator kế tiếp.
